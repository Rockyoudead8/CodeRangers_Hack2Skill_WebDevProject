import { validateSocketEvent, } from "./socketSchemas.js";
// ==========================================
 ...
 */
export function createValidatedHandler(eventName, handler) {
 ...
 */
export function onValidated(socket, eventName, handler) {
 ...
 */
export function isRateLimited(socketId, eventName, config = { maxRequests: 100, windowMs: 60000 }) {
