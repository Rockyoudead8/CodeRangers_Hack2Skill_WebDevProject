...
export default function AboutPage() {
  return (
    <div
      className="
        min-h-screen px-4 sm:px-6 lg:px-8 py-20 sm:py-24
        bg-gradient-to-br
    ...
    >
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-gray-700 dark:text-gray-400 mt-4 text-base sm:text-lg">
      ...
      {/* Stats */}
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6 mt-10 sm:mt-14">
        
        <div
          className="
            backdrop-blur-xl rounded-2xl p-5 sm:p-6 text-center transition
      ...
      {/* Mission Section */}
      <div className="max-w-4xl mx-auto mt-14 sm:mt-20 text-center">
        <HeartHandshake className="mx-auto text-pink-500 dark:text-pink-400" size={50}/>
        <h2 className="text-2xl sm:text-3xl font-bold mt-4">Our Mission</h2>

        <p className="text-gray-700 dark:text-gray-400 mt-4 leading-relaxed text-sm sm:text-base">
      ...
      {/* Footer */}
      <div className="text-center text-gray-600 dark:text-gray-500 text-sm mt-14 sm:mt-20">
